...
int ejercicio1()
{
	...
	CrearCilindro(9, 1.0f);//índice 2 en MeshList
	...
	glm::mat4 modelaux_cabina(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(2*mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
...
int ejercicio2()
{
	...
	glm::mat4 model(1.0);//Inicializar matriz de Modelo 4x4
	glm::mat4 modelaux(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 model_cuerpo(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para el cuerpo
	glm::mat4 model_cabeza(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la cabeza
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 3.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		model = model_cuerpo;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(3.5f, 1.4f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 0.2f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.25f, 1.75f, 1.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.8f, 3.5f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		model = glm::scale(model, glm::vec3(2.25f, 1.8f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.5f));
		model = glm::scale(model, glm::vec3(2.15f, 1.7f, 1.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		...
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.3f, 5.0f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		//EXTREMIDAD DELANTERA DERECHA
		//Articulacion (hombro derecho)
		model = model_cuerpo;
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.8f, 0.25f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		
		//Articulacion (codo derecho)
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.75f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(4.0f, 0.7f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();

		//Articulacion (tarso delantero derecho)
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		...
		//Articulacion (tarso delantero izquierdo)
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.5f, 0.7f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();

		//Articulacion (tarso trasero derecho)
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, -1.0f, 0.0f));
		modelaux = model;
		...
		//Articulacion (rodilla izquierda)
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.75f));
		...
		//Articulacion (tarso trasero izquierdo)
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(0.0f, -1.0f, 0.0f));
		modelaux = model;
