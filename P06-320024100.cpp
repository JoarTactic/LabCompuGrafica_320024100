...
int main()
{
	...
	coche_llanta_DD.LoadModel("Models/Coche_llanta_DD.obj");
	coche_llanta_DI = Model();
	coche_llanta_DI.LoadModel("Models/Coche_llanta_DI.obj");
	coche_llanta_TD = Model();
	coche_llanta_TD.LoadModel("Models/Coche_llanta_TD.obj");
	coche_llanta_TI = Model();
	coche_llanta_TI.LoadModel("Models/Coche_llanta_TI.obj");
